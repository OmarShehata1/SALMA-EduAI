    ...
    <div ref={sectionRef}  id="features" className="py-24 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className={`transition-all duration-700 transform ${
          ...
          <h2 className="text-4xl font-bold text-center mb-4"style={{ fontFamily: 'Patrick Hand, cursive' }}>Key Features</h2>
          <p className="text-gray-700 text-center max-w-2xl mx-auto mb-16"style={{ fontFamily: 'Patrick Hand, cursive' }}>
