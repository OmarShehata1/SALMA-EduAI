...
export default function CreateFullExamPage() {
  ...
  const generateQuestions = () => {
    ...
    setTimeout(() => {
      ...
      const mockQuestions = Array.from({ length: numQuestions }, (_, i) => ({
        id: i + 1,
        question: `Sample ${difficulty.toLowerCase()} question about ${topic || 'selected topic'} (#${i + 1})`,
        answer: `Sample answer for question #${i + 1} about ${topic || 'this topic'}.`,
  ...
  return (
    <div className="container mx-auto px-4 py-8 mt-16">
      ...
      <h1 className="text-3xl font-bold text-blue-600 mb-6">Create Full Exam</h1>
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <p className="text-gray-700 mb-6">
          Upload PDF files or documents to generate a complete exam. Our AI will analyze your content 
          and create questions based on your specifications. You can then review, edit, or delete questions
          before finalizing your exam.
        </p>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
          <div className="flex">
            ...
            <p className="text-sm text-blue-700">
              Upload your content files in PDF format. Set the number of questions and difficulty level, 
              then generate your exam. You can edit or remove questions as needed.
            </p>
          </div>
        </div>
        </div>
      ...
      {!showQuestions ? (
        ...
        <>
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-blue-600">Question Generator</h1>
            <button 
